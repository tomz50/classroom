...
public class ReturnOnAttendanceMainActivity extends AppCompatActivity implements View.OnClickListener  {
...
//        tvAttendanceDate.setText("2018-07-19");
//        //按鈕行為設定
    ...
    private void loadListViewData(){
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intentPutExtraS();
                String type;
                if (data_list.get(position).getId().equals("null")){
                    Log.i("DBuserid=","xx1"+data_list.get(position).getId().toString());
                ...
                intent.putExtra("title","請假回報");
                intent.putExtra("type",type);
//                Log.i("name=",data_list.get(position).getId());
                changeView(ReturnOnAttendanceMainActivity.this, ReturnOnAttendanceEditActivity.class);
            }
        });
    }
