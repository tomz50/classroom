...
public class CommunicationBookTeacherMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_communication_book_teacher_main);
        checkLogin();
        initView();
        classcodeSpinner();
        loadListViewData();
    ...
    private void loadListViewData(){
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("title","聯絡簿修改(導師)");
...
//                Log.i("name=",data_list.get(position).getId());
                changeView(CommunicationBookTeacherMainActivity.this, CommunicationBookTeacherEditActivity.class);
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.communicationbook_menu_insert, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.action_add:
                Log.v("!!attendancedate","==>"+tvAttendanceDate.getText());
                intent.putExtra("title","導師建立聯絡資料");
                intent.putExtra("classid", tvClassId.getText());
                intent.putExtra("attendancedate", tvAttendanceDate.getText());
                changeView(this, CommunicationBookTeacherInsertActivity.class);
                break;
        }
