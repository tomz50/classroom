...
public class CommunicationBookUpdateDataStudent extends AsyncTask<String, Void, String> {
    ...
    public CommunicationBookUpdateDataStudent(Context context, String[] data) {
        this.c = context;
        getData = data;
    ...
    protected void onPostExecute(String s) {
        ...
        if (isSuccess != -1){
            ...
            Intent intent = new Intent(c,CommunicationBookStudentMainActivity.class);
            ...
            intent.putExtra("s_level",getData[5]);
            intent.putExtra("classid",getData[6]);
            intent.putExtra("attendancedate",getData[7]);
