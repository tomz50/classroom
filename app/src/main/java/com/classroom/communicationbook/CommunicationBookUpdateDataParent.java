...
public class CommunicationBookUpdateDataParent extends AsyncTask<String, Void, String> {
    ...
    public CommunicationBookUpdateDataParent(Context context, String[] data) {
        this.c = context;
        getData = data;
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            request.writeBytes("Content-Disposition: form-data; name=\"PrContact\"" + "\"" + crlf);
            request.writeBytes(crlf);
    ...
    protected void onPostExecute(String s) {
        ...
        if (isSuccess != -1){
            ...
            Intent intent = new Intent(c,CommunicationBookParentMainActivity.class);
            ...
            intent.putExtra("s_level",getData[6]);
            intent.putExtra("classid",getData[7]);
            intent.putExtra("attendancedate",getData[8]);
