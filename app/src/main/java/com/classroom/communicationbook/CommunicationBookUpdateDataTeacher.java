...
public class CommunicationBookUpdateDataTeacher extends AsyncTask<String, Void, String> {
    ...
    public CommunicationBookUpdateDataTeacher(Context context, String[] data) {
        this.c = context;
        getData = data;
    ...
    protected void onPostExecute(String s) {
        ...
        if (isSuccess != -1){
            ...
            intent.putExtra("s_userid",getData[3]);
            intent.putExtra("s_login",getData[4]);
            intent.putExtra("s_groupid",getData[5]);
            intent.putExtra("s_name",getData[6]);
            intent.putExtra("s_level",getData[7]);
            intent.putExtra("classid",getData[8]);
            intent.putExtra("attendancedate",getData[9]);
