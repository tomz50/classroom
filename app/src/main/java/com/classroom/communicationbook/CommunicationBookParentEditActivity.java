...
public class CommunicationBookParentEditActivity extends AppCompatActivity implements View.OnClickListener{
    private CommunicationBookUpdateDataParent updateData;
    ...
    private TextView tvAttendanceDate,tvClassId,tvStUserid, tvName,tvHomeWork,tvThContact,tvThTime,tvStTime,tvPrTime;
    private EditText edtPrContact;
    private Button btnConfirm,btn_back;
    private String type;
    private Intent intent;
    private String queryId,newHomeWork,newPrContact;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_communication_book_parent_edit);
        checkLogin();
        initView();
        ...
        try {
            ...
            tvPrTime.setText(data_list.get(0).getPrtime());
            if(tvPrTime.getText().equals("null"))
                tvPrTime.setText(null);
            edtPrContact.setText(data_list.get(0).getPrcontact());
            if(edtPrContact.getText().toString().equals("null"))
                edtPrContact.setText(null);
    ...
    private void initView(){
        ...
        tvPrTime = findViewById(R.id.tvPrTime);
        tvThContact = findViewById(R.id.tvThContact);
        edtPrContact = findViewById(R.id.edtPrContact);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btnConfirm:
                newPrContact = edtPrContact.getText().toString();
                isEdit = false;
                String[] datau = new String[]{queryId,newPrContact,s_userid,s_login,s_groupid,s_name,"2",classid,attendancedate};
                updateData = new CommunicationBookUpdateDataParent(CommunicationBookParentEditActivity.this,datau);
                updateData.execute("https://webhost2503.000webhostapp.com/classroom/communicationbook/communicationbook_update_parent.php");
                break;
            case R.id.btnBack:
                Intent i = new Intent(this, CommunicationBookParentMainActivity.class);
                intentPutExtraS();
                startActivity(i);
                this.finish();
                break;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            case R.id.action_back:
                intent = new Intent(CommunicationBookParentEditActivity.this, CommunicationBookParentMainActivity.class);
                intentPutExtraS();
                startActivity(intent);
                this.finish();
                break;
