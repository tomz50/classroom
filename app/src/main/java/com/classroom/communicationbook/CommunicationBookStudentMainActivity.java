...
public class CommunicationBookStudentMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_communication_book_student_main);
        checkLogin();
        initView();
        classcodeSpinner();
        loadListViewData();
    ...
    private void loadListViewData(){
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("title","聯絡簿完成功課回覆(學生)");
...
//                Log.i("name=",data_list.get(position).getId());
                changeView(CommunicationBookStudentMainActivity.this, CommunicationBookStudentEditActivity.class);
            }
        });
    }
