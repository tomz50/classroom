...
public class AttendanceDetails {
    ...
    public AttendanceDetails(String id, String userid, String name, String attendancetime_i, String attendancetime_o, String trtime, String attendancedate, String reason) {
        this.id = id;
        this.userid = userid;
        this.name = name;
